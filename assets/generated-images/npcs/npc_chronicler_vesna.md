...
PROMPT:
Full-body character concept of Chronicler Vesna (Летописец Весна), a key NPC from town_oakhaven. Dark fantasy RPG style, practical layered clothing, lore-authentic gear, expressive face, realistic proportions, neutral standing pose plus subtle personality gesture, plain atmospheric background tied to Oakhaven frontier.

NEGATIVE PROMPT:
modern city, sci-fi neon, cartoon, anime, lowpoly, blurry, lowres, text, logo, watermark, deformed anatomy, oversaturated colors

OUTPUT: npc_chronicler_vesna.png